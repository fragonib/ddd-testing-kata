pluginManagement {
    ...
    resolutionStrategy {
        ...
        val contractVerifierPluginVersion: String by settings
        eachPlugin {
            ...
            if (requested.id.id == "org.springframework.cloud.contract") {
                useModule("org.springframework.cloud:spring-cloud-contract-gradle-plugin:$contractVerifierPluginVersion")
            }
        }
    }
}
